...
import { useSingUpStore } from '../stores/singUpStore';
import { ref } from 'vue';
...
const handleSubmit = async () => {
    try  {
        const response = await axios.post(
            import.meta.env.VITE_API_BASE_URL+'singup', {
                name: this.name,
...
<template>
    <div class="mt-10">
        <div v-if="singUpStore.isCreated" class="flex mb-2">
            <h5 class="font-bold text-green-600">Enregister</h5>
        </div>
